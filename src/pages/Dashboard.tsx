...
export default function Dashboard() {
  ...
  const addTicker = async () => {
    ...
    if (!sym || !user) return;
    if (!/^[A-Z]{1,6}$/.test(sym)) {
      toast({ title: "Invalid symbol", description: "Use 1–6 letters (e.g. QQQ, SPY, NDX).", variant: "destructive" });
      return;
    }
        ...
        <DialogContent>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="QQQ, SPY, NDX..."
            />
            <p className="text-xs text-muted-foreground">Live data via CBOE for QQQ, SPY, NDX and US-listed symbols.</p>
          </div>
          <DialogFooter>
