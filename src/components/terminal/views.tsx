      ...
      <div className="p-3">
        <TerminalTabs
          ...
          tabs={[
            ...
            {
              key: "flow",
              label: <span style={{ background: "linear-gradient(90deg, #ffffff, #1e40af)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontWeight: 800 }}>HEATMAP</span> as any,
